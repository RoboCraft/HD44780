...
#include "hd44780_stm32l1xx.h"
  ...
  #define HD44780_STM32L1XX_ASSERT(x) \
    { \
      if (!(x)) \
      { \
        HD44780_STM32L1xx_GPIO_Driver *driver = ((HD44780_STM32L1xx_GPIO_Driver*)interface); \
...
static HD44780_Result stm32l1xx_default_pin_configure(
  HD44780_GPIO_Interface *interface, HD44780_Pin pin, HD44780_PinMode mode)
{
  HD44780_STM32L1XX_RETURN_ASSERT(interface != NULL, HD44780_RESULT_ERROR);

  HD44780_STM32L1xx_GPIO_Driver *driver = (HD44780_STM32L1xx_GPIO_Driver*)interface;
  HD44780_STM32L1xx_Pin *hw_pin = &driver->pinout.pins[pin];

  HD44780_STM32L1XX_RETURN_ASSERT(hw_pin != NULL, HD44780_RESULT_ERROR);
  HD44780_STM32L1XX_RETURN_ASSERT(hw_pin->gpio != NULL, HD44780_RESULT_ERROR);
...
static HD44780_Result stm32l1xx_default_pin_write(
...
static HD44780_Result stm32l1xx_default_pin_read(
  HD44780_GPIO_Interface *interface, HD44780_Pin pin, HD44780_PinState *value)
{
  HD44780_STM32L1XX_RETURN_ASSERT(interface != NULL, HD44780_RESULT_ERROR);
